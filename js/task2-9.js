...
function isLoginValid(login, min = 4, max = 16) {
  const loginCheck = login.length >= min && login.length <= max;
  return loginCheck;
...
function isLoginUnique(allLogins, login) {
  //   const loginSearch = allLogins.includes(login);
  //   return loginSearch;
...
// console.log(isLoginValid("robjkjklj"));

// console.log(isLoginUnique(logins, "Poly"));

// console.log(isLoginUnique(logins, "1234")); //false
// console.log(isLoginUnique(logins, "4444")); //true
